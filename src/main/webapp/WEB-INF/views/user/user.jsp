	                ...
	                <div class="x_panel">
	                    ...
	                    <div class="x_content">
	                    	<div class="control-group">
                                <a type="button" class="btn btn-primary" href="${pageContext.request.contextPath}/usuarios/cadastro">Cadastrar Usuários</a>
                            </div>
								<div class="control-group">
									<table id="entities" class="table table-striped responsive-utilities jambo_table">		
										...
										<tbody>
											...
											<c:forEach items="${usersList}" var="usuarios" varStatus="status">
