        ...
        options: {
            ...
            // Callback for failed (abort or error) uploads:
             fail: function (e, data) {            	 
            	 var that = $(this).data('blueimp-fileupload') || $(this).data('fileupload'), options = that.options,
                 files = data.files;
            	 ...
            	 $.each(files, function (index, file) {
                     ...
                     if (file.size > 1000000) {
                    	 ...
                    	 $(".jquery_error").empty();
                    	 $(".jquery_error").append("Um dos arquivos que tem tamanho "+file.size+" bytes excedeu o tamanho maximo de 1000000 bytes");
                     }
                 });
